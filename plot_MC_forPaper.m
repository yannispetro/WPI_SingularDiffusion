function [] = plot_MC_forPaper( MC_file,LinT_file, tf )
    ...
    if exist(MC_file, 'file') == 2
        ...
        FIG1 = figure(1);
        plot(xmesh1,pdf_x_MC,'LineStyle','-','Linewidth',3); hold on
        FIG2 = figure(2);
        plot(xmesh2,pdf_y_MC,'LineStyle','-','Linewidth',3); hold on
        FIG3 = figure(3);
        plot(xmesh3,pdf_x_dot_MC,'LineStyle','-','Linewidth',3); hold on
        FIG4 = figure(4);
        plot(xmesh4,pdf_y_dot_MC,'LineStyle','-','Linewidth',3); hold on
% 
