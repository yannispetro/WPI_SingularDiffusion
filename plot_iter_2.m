function [] = plot_iter_2( x1, x2, x3, x4, PDF,it,ik )
...
%         figure(3);
    ...
    if it == 1 && ik == 7
        subplot(1,4,1);
        plot(x1,f1, 'x','LineStyle',':','Color',[1 0 0],'Linewidth',2,'MarkerSize',10); hold on
        subplot(1,4,2);
        plot(x2,f2, 'x','LineStyle',':','Color',[1 0 0],'Linewidth',2,'MarkerSize',10); hold on
        subplot(1,4,3);
        plot(x3,f3, 'x','LineStyle',':','Color',[1 0 0],'Linewidth',2,'MarkerSize',10); hold on
        subplot(1,4,4);
        plot(x4,f4, 'x','LineStyle',':','Color',[1 0 0],'Linewidth',2,'MarkerSize',10); hold on
    end
